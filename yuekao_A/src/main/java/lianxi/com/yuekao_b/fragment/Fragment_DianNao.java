...
import lianxi.com.yuekao_b.bean.TuPianBean;
import lianxi.com.yuekao_b.inter.JsonCallBack;
...
public class Fragment_DianNao extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.diannao_layout, container, false);
        gridView = (GridView) view.findViewById(R.id.gridview);
        imageView = (ImageView) view.findViewById(R.id.fenlei_imageView);
