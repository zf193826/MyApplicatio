...
import lianxi.com.yuekao_b.fragment.Fragment_FaXian;
import lianxi.com.yuekao_b.fragment.Fragment_FenLei;
import lianxi.com.yuekao_b.fragment.Fragment_GouWuChe;
import lianxi.com.yuekao_b.fragment.Fragment_ShouYe;
            ...
            public void onCheckedChanged(RadioGroup radioGroup, @IdRes int i) {
                switch (i){
                    case R.id.radio_01:
                        ...
                        break;
                    case R.id.radio_02:
                        getSupportFragmentManager().beginTransaction().replace(R.id.fragment_layout,new Fragment_FenLei()).commit();
                        break;
                    case R.id.radio_03:
                        getSupportFragmentManager().beginTransaction().replace(R.id.fragment_layout,new Fragment_FaXian()).commit();
                        break;
                    case R.id.radio_04:
                        getSupportFragmentManager().beginTransaction().replace(R.id.fragment_layout,new Fragment_GouWuChe()).commit();
                        break;
                    case R.id.radio_05:
